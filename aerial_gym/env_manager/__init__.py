...
from aerial_gym.config.env_config.quad_flight_dynamic_env import QuadFlightDynamicEnvCfg
from aerial_gym.config.env_config.simple_target_env import SimpleTargetEnvCfg
from aerial_gym.config.env_config.hard_target_env import HardTargetEnvCfg
...
env_config_registry.register("simple_target_env", SimpleTargetEnvCfg)
env_config_registry.register("hard_target_env", HardTargetEnvCfg)
env_config_registry.register("quad_flight_dynamic_env", QuadFlightDynamicEnvCfg)
