...
if __name__ == "__main__":
    ...
    actions[:, 0:3] = torch.tensor([1.0, 1.0, 1.0], device="cuda:0")
    env_manager.reset()
    num_assets_in_env = (
    ...
    for i in range(10000):
        dis = torch.norm(env_manager.get_obs_position()[0, uav_indices[0]] - torch.tensor([1.0, 1.0, 1.0], device="cuda:0"))

        asset_twist[0, uav_indices[0], 0:3] = 0.1 / dis * (torch.tensor([1.0, 1.0, 1.0], device="cuda:0") - env_manager.get_obs_position()[0, uav_indices[0]]) 
