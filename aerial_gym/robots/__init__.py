...
from aerial_gym.config.robot_config.base_quad_config import x500Cfg
...
robot_registry.register("base_quadrotor_with_pointcloud_depth_camera", BaseMultirotor, BaseQuadWithPointCloudDepthCameraCfg)
robot_registry.register("base_quadrotor_with_lidar", BaseMultirotor, BaseQuadWithLidarCfg)
robot_registry.register("base_quadrotor_with_depth_lidar", BaseMultirotor, BaseQuadWithDepthLidarCfg)
